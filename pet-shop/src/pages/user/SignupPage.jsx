          ...
          <div className="flex items-center justify-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Location Field */}
                <div>
                  <label htmlFor="location" className="text-start block text-sm font-medium text-gray-700 mb-2">
                    Location <span className="text-gray-400 font-normal"></span>
                  </label>
                  <div className="absolute inset-y-0 left-0 pl-11 pt-[370px] flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Philippines, Manila"
                      required
                      className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-sm"
                    />
                </div>
